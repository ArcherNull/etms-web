/*
 * @Author: Null
 * @Date: 2022-08-31 09:08:20
 * @Description: 银行卡号自动识别
 */
...
export function bankCardAttribution (bankCard, type = 'cardNo') {
  var cardTypeMap = {
    DC: '储蓄卡',
    CC: '信用卡',
    SCC: '准贷记卡',
  ...
  if (type === 'cardNo') {
    return getBankInfoByCardNo(bankCard)
  } else {
    return getBankNameByBankCode(bankCard)
  }
}
